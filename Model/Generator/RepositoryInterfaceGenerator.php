...
class RepositoryInterfaceGenerator
{
    ...
    protected function prepareData(ModelContext $context)
    {
        ...
        $saveMethod = $factory->method('save')
            ->makePublic()
            ->addParam($factory->param($context->getVariableName())->setTypeHint($context->getModelInterface()->getShortName()))
        ...
        $getListMethod = $factory->method('getList')
            ->makePublic()
            ->addParam($factory->param('searchCriteria')->setTypeHint('SearchCriteriaInterface'))
